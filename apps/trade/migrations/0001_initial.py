# Generated by Django 2.0 on 2018-10-18 12:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ship_no', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='物流信息')),
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('cancel', '待支付')], default='paying', max_length=30, verbose_name='订单状态')),
